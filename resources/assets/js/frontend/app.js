...
$(document).ready(function(){
	$('.course_view').hover(function(){
		if($(this).hasClass('animated zoomIn'))
			$(this).removeClass('animated zoomIn')
		if($(this).hasClass('animated jello'))
			$(this).removeClass('animated jello')
		$(this).addClass('animated pulse');
	})
	$('.course_view').mouseleave(function(){
...
$('.carousel').carousel();
	setTimeout( ()=>{
		...
		$('.owl-buttons').css({ 'z-index' : '10 !important' })
	}, 2000)
	$('html').prepend('<div style=  "z-index : 200 !important" class = "loading-main-wrapper"><center><div class="loading-wrapper-content animated rotateIn infinite"><p class = "animated rubberBand infinite">RAQ</p></div></center></div>');
	setTimeout( ()=>{$('.loading-main-wrapper').remove()} , 3000)
})
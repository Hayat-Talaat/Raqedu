...
@section('content')
    <div class="jumbotron" >
        <div class="bg-stripe-overlay black" style="padding-bottom: 120px !important;">
            <div class="container">
                <div class="center">
    ...
    <section class="course-top grey lighten-4">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-5" style="margin-top: -120px ">
                    <div class="sidebar-course-intro ">
                        <div class="video-course-intro enrolled transparent" >
                            <div class="inner border-0 border-radius-sm">
                                <div class="video-place centerized " >
                                    <div class="img-thumb" >
                                        <img  src="{{ Helper::coverImage($course) }}" alt="">
                                    </div>
                                    <div class="awe-overlay"></div>
                                    <a href="#" style="border-radius: 10px !important; background-color: transparent !important;" class="play-icon circle transparent" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#preview-video">
                                        <i style="border-radius: 10px !important; background-color: rgba(0,0,0,0.4) !important;" class="fa fa-play border-radius-sm">
                                        </i>
                                    </a>
                                </div>
                        ...
                        <div class="new-course blue-grey lighten-4 border-radius-m">
                            <div class="item course-code text-center ">
                                <i class="icon md-barcode"></i>
                                <h4><a class="text-thin text-smd" href="#">{{trans('strings.frontend.sections')}}</a></h4>
                                <p class="detail-course blue-text text-thin text-lg">{{$course->sections->count()}}</p>
                            </div>
                            <div class="item course-code text-center">
                                <i class="icon md-time"></i>
                                <h4><a class="text-thin text-smd" href="#">{{trans('strings.frontend.avg-rating')}}</a></h4>
                                <p class="text-thin blue-text text-smd" class="detail-course">{{ $course->total_reviews > 0 ?  $course->average_rating : trans('strings.frontend.not-rated') }}</p>
                            </div>
                            <div class="item course-code text-center">
                                <i class="icon md-time"></i>
                                <h4><a class="text-thin text-smd" href="#">{{trans('strings.frontend.wishlist')}}</a></h4>
                            ...
                            <div class="item course-code text-center">
                                ...
                                <h4><a class="text-thin text-smd" href="#">{{trans('strings.frontend.updated')}}</a></h4>
                                <p class="detail-course blue-text text-thin text-md">{{ $course->updated_at->diffForHumans() }}</p>
                            </div>
                            <center>
                ...
                <div class="col-md-7">
                    <div class="tabs-page">
                        <ul class="nav-tabs " role="tablist">
                            <li class="active"><a href="#introduction" class="text-md text-thin" role="tab" data-toggle="tab">
                                {{trans('strings.frontend.description')}}
                            </a></li>
                            <li><a href="#outline" role="tab" class="text-md text-thin" data-toggle="tab">{{trans('strings.frontend.content')}}</a></li>
                            <li><a href="#review" role="tab" class="text-md text-thin" data-toggle="tab">{{trans('strings.frontend.feedback')}}</a></li>
                        </ul>
                        <!-- Tab panes -->
                        <div class="tab-content grey-text">

                            <!-- INTRODUCTION -->
                            <div class="tab-pane fade in active grey-text" id="introduction">
                                {!! $course->description !!}
                            </div>
                            <!-- END / INTRODUCTION -->
                            ...
                            <!-- OUTLINE -->
                            <div class="tab-pane grey-text fade" id="outline">

                                <!-- SECTION OUTLINE -->
                                @foreach($course->sections as $section)
                                    @if($section->lessons->count())
                                    <div class="section-outline grey-text">
                                            ...
                                            @foreach($section->lessons as $lesson)
                                                ...
                                                <li>
                                                    ...
                                                    <div class="list-body">
                                                        ...
                                                        <div class="data-lessons grey-text clearfix">
                                                            {{ $lesson->description }}
                                                        </div>
                                                    </div>
                            ...
                            <div class="about-instructor">
                                <h4 class="xsm bold">{{trans('strings.frontend.about-instructor')}}</h4>
                                <ul style="padding-left:0; list-style-type: none;">
                                    <li>
                                        <div class="image-instructor text-center">
                                            <img class="circle" src="{{ $course->author->picture }}" alt="">
                                        </div>
                                        <div class="info-instructor">
                                            <cite class="sm"><a href="{{route('frontend.user.public.profile', $course->author)}}">{{$course->author->name}}</a></cite>

...
@section('content')
    ...
    <div class="jumbotron" style="z-index: 2;" id = "main-jumbotron">
            ...
            <div class="container">
                <div class="row top-row">
                    <div class="col-md-6">
                        ...
                        <img class = "col s8 push-s2 animated rotateIn circle z-depth-2" src = "{{asset('/logo.png')}}" />
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="left">
                                @if(!auth()->check())
                                    <p style="font-weight: 200 !important; font-size: 300% !important">{!!trans('strings.frontend.homepage-caption')!!}</p>
                                    <p>{!!trans('strings.frontend.homepage-paragraph')!!}</p>

                                    <div class="button-set" style="padding:0;box-shadow:none;">
                                      <a
                                      style = "padding-top: 15px !important; padding-bottom: 15px !important; height: auto !important;"
                                      class="btn  bulma button is-primary btn-lg is-large" href="{{route('frontend.auth.login')}}">
                                          {!! trans('navs.frontend.login') !!}
                                      </a>
                                      <span class=" hidden-xs text-md side-padding-5px  bounds-respect-padding-top-10px"></span>
                                      <a href="{{route('frontend.auth.register')}}"
                                      style = "padding-top: 15px !important; padding-bottom: 15px !important; height: auto !important;"
                                      class="btn  bulma button is-danger btn-lg is-large">
    ...
    @if(config('settings.adsense_top_responsive_slot') != '')
        <section style="padding:25px 0px; " id="mc-section-3" class="mc-section-3 section ">
            <div class="container">
            <center>
    ...
    @if($featuredCategories->count() > 0)
        @foreach($featuredCategories as $category)
            ...
            <section id="mc-section-3" style="padding:25px 0px; " class="mc-section-3 section">
                <div class="container">
                    <!-- FEATURE -->
